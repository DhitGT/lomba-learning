...
<div class="container">
    ...
    <div class=" min-w-[100vw]">
        <div class="flex max-w-fit flex-col mx-auto my-11 ">
            <p data-aos="fade-up" class="my-3 text-3xl font-semibold leading-relaxed text-gray-900 dark:text-white text-center">Hello, whats you wanna do today?</p>
         ...
         <div class="row mx-auto max-w-[80vw] my-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div data-aos="fade-down"  class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col">
                <a href="#" class="block overflow-hidden">
                    <img class="w-full h-48 object-cover rounded-t-lg" src="{{ $module['image'] }}" alt="{{ $module['title'] }}" />
                </a>

...
<div class="container">
        ...
        <section class="relative min-h-[100vh] min-w-[100vw] pt-24 md:pt-0 transition-opacity duration-500 ease-in-out">
            ...
            <div class="relative z-20 px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                ...
                <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
                    Learning How To Code from expert, and Share your knowlage to others
                </p>
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    ...
                    <a href="#about-us"
                        ...
                        <span class="text-[#80AF81]">Learning</span>
                    </a>
                </div>
            </div>
        </section>
    ...
    <div class=" min-w-[100vw]">
        <div class="flex max-w-fit flex-col mx-auto my-11 ">
            <p class="my-3 text-3xl font-semibold leading-relaxed text-gray-900 dark:text-white text-center">Hello, whats you wanna do today?</p>
            <div class="flex gap-3 justify-between">
                ...
                <p class="font-normal text-gray-700 dark:text-gray-400">Share Your Knowlage to otthers</p>
                </a>
                <a href="#" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Learning</h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">Learning Some new skill from experts</p>
                </a>
    ...
    <div class="min-w-[100vw]">
        ...
        <!-- card untuk modul -->
         <div class="row mx-auto max-w-[80vw] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($modules as $module)
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src="{{ $module['image'] }}" alt="{{ $module['title'] }}" />
                </a>
                <div class="p-5">
                    <a href="#">
...
<script>
    const videos = [
        "{{ asset('video/jumbo-bg.mp4') }}",
        "{{ asset('video/jumbo-bg-2.mp4') }}",
        "{{ asset('video/jumbo-bg-3.mp4') }}"
    ];
    ...
    videoElement.addEventListener('ended', () => {
        ...
        setTimeout(() => {
            ...
            // Add fade-in effect after changing video
            videoElement.classList.remove('opacity-0');
            videoElement.classList.add('opacity-100');
        }, 1000); // Match this duration to the transition duration for smooth fading
    });
</script>
@endsection
